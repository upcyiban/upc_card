<template>
  <div class="cardfinder-container">
    ...
    <div class="select-container">
      <div style="background:white" @click="gopickedcard">找主人</div>
      <div style="margin-left:1px;background:rgb(255, 255, 154)" @click="golostcard">找卡</div>
    </div>
    <div class="cardinfos">
      <div class="cardinfo" v-for="info in infos" :key="info.num">
        ...
        <div class="contectinfo">
          <div style="color:grey;width:40%">请失主联系</div>{{info.contact}}
        </div>
        <div class="remark">
